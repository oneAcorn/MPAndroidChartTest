...
public class TestPieChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_piechart);
...
//        chart.setCenterText(generateCenterSpannableText());
        ...
        chart.setExtraOffsets(5f, 20f, 5f, 0f);
...
//        chart.setDrawCenterText(true);
        ...
        chart.setRotationAngle(270.001f);
    ...
    private void setData(int count, float range) {
        ...
        entries.add(new PieEntry(0f, "A类SKU数 0.60%"));
        // NOTE: The order of the entries when being added to the entries array determines their position around the center of
        // the chart.
        for (int i = 0; i < count; i++) {
            entries.add(new PieEntry((float) (Math.random() * range) + range / 5, parties[i % parties.length]));
        }
//        entries.add(new PieEntry(0.001f, "A类SKU数 0.60%"));
//        entries.add(new PieEntry(1000f, "B类SKU数 6.82%"));
//        entries.add(new PieEntry(100f, "B类SKU数 6.82%"));
//        entries.add(new PieEntry(92.58f, "C类SKU数 92.58%"));
